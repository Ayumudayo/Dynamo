...
| Settings grouping | [dashboard/routes/guild-manager.js](/E:/Repos/MyRepos/DiscordBots/Dynamo/dashboard/routes/guild-manager.js) | Group settings by operator task: basic, greeting, moderation, stats, ticket | Partially preserved; keep refining grouping language |
...
| Giveaway manager split | [src/handlers/giveaway.js](/E:/Repos/MyRepos/DiscordBots/Dynamo/src/handlers/giveaway.js) | Separate persistence-backed giveaway runtime and command surface | Preserved; now promoted to core |
