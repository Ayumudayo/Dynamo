...
pub(crate) const DEFAULT_REFRESH_INTERVAL_SECONDS: u32 = 3;
pub(crate) const MIN_REFRESH_INTERVAL_SECONDS: u32 = 3;
pub(crate) const DEFAULT_REFRESH_DURATION_SECONDS: u32 = 120;
pub(crate) const MIN_REFRESH_DURATION_SECONDS: u32 = 60;
pub(crate) const MAX_REFRESH_DURATION_SECONDS: u32 = 180;
pub(crate) const REFRESH_INTERVAL_MS: u32 = DEFAULT_REFRESH_INTERVAL_SECONDS * 1_000;
pub(crate) const MAX_REFRESH_TIME_MS: u32 = DEFAULT_REFRESH_DURATION_SECONDS * 1_000;
